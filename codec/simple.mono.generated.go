...
func (e *encoderSimpleBytes) setContainerState(cs containerState) {
	if cs != 0 {
		e.c = cs
	}
}

func (e *encoderSimpleBytes) rawExt(f *encFnInfo, rv reflect.Value) {
...
func (e *encoderSimpleBytes) selferMarshal(f *encFnInfo, rv reflect.Value) {
	rv2i(rv).(Selfer).CodecEncodeSelf(&Encoder{e})
}

func (e *encoderSimpleBytes) binaryMarshal(f *encFnInfo, rv reflect.Value) {
	bs, fnerr := rv2i(rv).(encoding.BinaryMarshaler).MarshalBinary()
	e.marshalRaw(bs, fnerr)
}

func (e *encoderSimpleBytes) textMarshal(f *encFnInfo, rv reflect.Value) {
	bs, fnerr := rv2i(rv).(encoding.TextMarshaler).MarshalText()
	e.marshalUtf8(bs, fnerr)
}

func (e *encoderSimpleBytes) jsonMarshal(f *encFnInfo, rv reflect.Value) {
	bs, fnerr := rv2i(rv).(jsonMarshaler).MarshalJSON()
	e.marshalAsis(bs, fnerr)
}

func (e *encoderSimpleBytes) raw(f *encFnInfo, rv reflect.Value) {
...
func (e *encoderSimpleBytes) kBool(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeBool(rvGetBool(rv))
}

func (e *encoderSimpleBytes) kTime(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeTime(rvGetTime(rv))
}

func (e *encoderSimpleBytes) kString(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeString(rvGetString(rv))
}

func (e *encoderSimpleBytes) kFloat32(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeFloat32(rvGetFloat32(rv))
}

func (e *encoderSimpleBytes) kFloat64(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeFloat64(rvGetFloat64(rv))
}

func (e *encoderSimpleBytes) kComplex64(f *encFnInfo, rv reflect.Value) {
	e.encodeComplex64(rvGetComplex64(rv))
}

func (e *encoderSimpleBytes) kComplex128(f *encFnInfo, rv reflect.Value) {
	e.encodeComplex128(rvGetComplex128(rv))
}

func (e *encoderSimpleBytes) kInt(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt(rv)))
}

func (e *encoderSimpleBytes) kInt8(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt8(rv)))
}

func (e *encoderSimpleBytes) kInt16(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt16(rv)))
}

func (e *encoderSimpleBytes) kInt32(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt32(rv)))
}

func (e *encoderSimpleBytes) kInt64(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt64(rv)))
}

func (e *encoderSimpleBytes) kUint(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint(rv)))
}

func (e *encoderSimpleBytes) kUint8(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint8(rv)))
}

func (e *encoderSimpleBytes) kUint16(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint16(rv)))
}

func (e *encoderSimpleBytes) kUint32(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint32(rv)))
}

func (e *encoderSimpleBytes) kUint64(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint64(rv)))
}

func (e *encoderSimpleBytes) kUintptr(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUintptr(rv)))
}

func (e *encoderSimpleBytes) kErr(f *encFnInfo, rv reflect.Value) {
...
func (e *encoderSimpleBytes) kStructSfi(f *encFnInfo) []*structFieldInfo {
	if e.h.Canonical {
...
func (e *encoderSimpleBytes) HandleName() string {
	return e.hh.Name()
}

func (e *encoderSimpleBytes) Release() {
}
...
func (e *encoderSimpleBytes) init(h Handle) {
	...
	e.fp = e.e.init(h, &e.encoderShared, e).(*fastpathEsSimpleBytes)
...
func (e *encoderSimpleBytes) addrRV(rv reflect.Value, typ, ptrType reflect.Type) (rva reflect.Value) {
	if rv.CanAddr() {
...
func (e *encoderSimpleBytes) wrapErr(v error, err *error) {
...
func (e *encoderSimpleBytes) haltOnMbsOddLen(length int) {
	if length&1 != 0 {
...
func (d *decoderSimpleBytes) selferUnmarshal(f *decFnInfo, rv reflect.Value) {
	rv2i(rv).(Selfer).CodecDecodeSelf(&Decoder{d})
}

func (d *decoderSimpleBytes) binaryUnmarshal(f *decFnInfo, rv reflect.Value) {
...
func (d *decoderSimpleBytes) textUnmarshal(f *decFnInfo, rv reflect.Value) {
	tm := rv2i(rv).(encoding.TextUnmarshaler)
	fnerr := tm.UnmarshalText(d.d.DecodeStringAsBytes())
	d.onerror(fnerr)
}

func (d *decoderSimpleBytes) jsonUnmarshal(f *decFnInfo, rv reflect.Value) {
...
func (d *decoderSimpleBytes) kErr(f *decFnInfo, rv reflect.Value) {
	d.errorf("unsupported decoding kind: %s, for %#v", rv.Kind(), rv)

}

func (d *decoderSimpleBytes) raw(f *decFnInfo, rv reflect.Value) {
	rvSetBytes(rv, d.rawBytes())
}

func (d *decoderSimpleBytes) kString(f *decFnInfo, rv reflect.Value) {
	rvSetString(rv, d.stringZC(d.d.DecodeStringAsBytes()))
}

func (d *decoderSimpleBytes) kBool(f *decFnInfo, rv reflect.Value) {
	rvSetBool(rv, d.d.DecodeBool())
}

func (d *decoderSimpleBytes) kTime(f *decFnInfo, rv reflect.Value) {
	rvSetTime(rv, d.d.DecodeTime())
}

func (d *decoderSimpleBytes) kFloat32(f *decFnInfo, rv reflect.Value) {
	rvSetFloat32(rv, d.d.DecodeFloat32())
}

func (d *decoderSimpleBytes) kFloat64(f *decFnInfo, rv reflect.Value) {
	rvSetFloat64(rv, d.d.DecodeFloat64())
}

func (d *decoderSimpleBytes) kComplex64(f *decFnInfo, rv reflect.Value) {
	rvSetComplex64(rv, complex(d.d.DecodeFloat32(), 0))
}

func (d *decoderSimpleBytes) kComplex128(f *decFnInfo, rv reflect.Value) {
	rvSetComplex128(rv, complex(d.d.DecodeFloat64(), 0))
}

func (d *decoderSimpleBytes) kInt(f *decFnInfo, rv reflect.Value) {
	rvSetInt(rv, int(chkOvf.IntV(d.d.DecodeInt64(), intBitsize)))
}

func (d *decoderSimpleBytes) kInt8(f *decFnInfo, rv reflect.Value) {
	rvSetInt8(rv, int8(chkOvf.IntV(d.d.DecodeInt64(), 8)))
}

func (d *decoderSimpleBytes) kInt16(f *decFnInfo, rv reflect.Value) {
	rvSetInt16(rv, int16(chkOvf.IntV(d.d.DecodeInt64(), 16)))
}

func (d *decoderSimpleBytes) kInt32(f *decFnInfo, rv reflect.Value) {
	rvSetInt32(rv, int32(chkOvf.IntV(d.d.DecodeInt64(), 32)))
}

func (d *decoderSimpleBytes) kInt64(f *decFnInfo, rv reflect.Value) {
	rvSetInt64(rv, d.d.DecodeInt64())
}

func (d *decoderSimpleBytes) kUint(f *decFnInfo, rv reflect.Value) {
	rvSetUint(rv, uint(chkOvf.UintV(d.d.DecodeUint64(), uintBitsize)))
}

func (d *decoderSimpleBytes) kUintptr(f *decFnInfo, rv reflect.Value) {
	rvSetUintptr(rv, uintptr(chkOvf.UintV(d.d.DecodeUint64(), uintBitsize)))
}

func (d *decoderSimpleBytes) kUint8(f *decFnInfo, rv reflect.Value) {
	rvSetUint8(rv, uint8(chkOvf.UintV(d.d.DecodeUint64(), 8)))
}

func (d *decoderSimpleBytes) kUint16(f *decFnInfo, rv reflect.Value) {
	rvSetUint16(rv, uint16(chkOvf.UintV(d.d.DecodeUint64(), 16)))
}

func (d *decoderSimpleBytes) kUint32(f *decFnInfo, rv reflect.Value) {
	rvSetUint32(rv, uint32(chkOvf.UintV(d.d.DecodeUint64(), 32)))
}

func (d *decoderSimpleBytes) kUint64(f *decFnInfo, rv reflect.Value) {
...
func (d *decoderSimpleBytes) HandleName() string {
	return d.hh.Name()
}

func (d *decoderSimpleBytes) isBytes() bool {
	return d.bytes
}
...
func (d *decoderSimpleBytes) init(h Handle) {
	...
	d.fp = d.d.init(h, &d.decoderShared, d).(*fastpathDsSimpleBytes)
...
func (d *decoderSimpleBytes) arrayCannotExpand(sliceLen, streamLen int) {
	if d.h.ErrorIfNoArrayExpand {
		d.errorf("cannot expand array len during decode from %v to %v", any(sliceLen), any(streamLen))
	}
}

func (d *decoderSimpleBytes) haltAsNotDecodeable(rv reflect.Value) {
	if !rv.IsValid() {
		d.onerror(errCannotDecodeIntoNil)
	}
...
func (d *decoderSimpleBytes) depthIncr() {
	d.depth++
...
func (d *decoderSimpleBytes) depthDecr() {
	d.depth--
}
...
func (d *decoderSimpleBytes) mapStart(v int) int {
...
func (d *decoderSimpleBytes) arrayStart(v int) int {
	if v != containerLenNil {
		d.depthIncr()
...
func (d *decoderSimpleBytes) oneShotAddrRV(rvt reflect.Type, rvk reflect.Kind) reflect.Value {
	if decUseTransient &&
...
func (d *simpleDecDriverBytes) DecodeStringAsBytes() (s []byte) {
	return d.DecodeBytes(nil)
}

func (d *simpleDecDriverBytes) DecodeBytes(bs []byte) (bsOut []byte) {
...
func (d *simpleDecDriverBytes) nextValueBytesR(v0 []byte) (v []byte) {
	d.readNextBd()
	v = v0
	var h decNextValueBytesHelper
...
func (d *simpleDecDriverBytes) nextValueBytesBdReadR(v0 []byte) (v []byte) {
	v = v0
	var h decNextValueBytesHelper
...
func (d *simpleEncDriverBytes) init(hh Handle, shared *encoderShared, enc encoderI) (fp interface{}) {
	callMake(&d.w)
	d.h = hh.(*SimpleHandle)
	d.e = shared
	if shared.bytes {
...
func (d *simpleDecDriverBytes) init(hh Handle, shared *decoderShared, dec decoderI) (fp interface{}) {
	callMake(&d.r)
	d.h = hh.(*SimpleHandle)
...
func (e *encoderSimpleIO) setContainerState(cs containerState) {
	if cs != 0 {
		e.c = cs
	}
}

func (e *encoderSimpleIO) rawExt(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeRawExt(rv2i(rv).(*RawExt))
}
...
func (e *encoderSimpleIO) selferMarshal(f *encFnInfo, rv reflect.Value) {
	rv2i(rv).(Selfer).CodecEncodeSelf(&Encoder{e})
}

func (e *encoderSimpleIO) binaryMarshal(f *encFnInfo, rv reflect.Value) {
	bs, fnerr := rv2i(rv).(encoding.BinaryMarshaler).MarshalBinary()
	e.marshalRaw(bs, fnerr)
}

func (e *encoderSimpleIO) textMarshal(f *encFnInfo, rv reflect.Value) {
	bs, fnerr := rv2i(rv).(encoding.TextMarshaler).MarshalText()
	e.marshalUtf8(bs, fnerr)
}

func (e *encoderSimpleIO) jsonMarshal(f *encFnInfo, rv reflect.Value) {
	bs, fnerr := rv2i(rv).(jsonMarshaler).MarshalJSON()
	e.marshalAsis(bs, fnerr)
}

func (e *encoderSimpleIO) raw(f *encFnInfo, rv reflect.Value) {
	e.rawBytes(rv2i(rv).(Raw))
}
...
func (e *encoderSimpleIO) kBool(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeBool(rvGetBool(rv))
}

func (e *encoderSimpleIO) kTime(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeTime(rvGetTime(rv))
}

func (e *encoderSimpleIO) kString(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeString(rvGetString(rv))
}

func (e *encoderSimpleIO) kFloat32(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeFloat32(rvGetFloat32(rv))
}

func (e *encoderSimpleIO) kFloat64(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeFloat64(rvGetFloat64(rv))
}

func (e *encoderSimpleIO) kComplex64(f *encFnInfo, rv reflect.Value) {
	e.encodeComplex64(rvGetComplex64(rv))
}

func (e *encoderSimpleIO) kComplex128(f *encFnInfo, rv reflect.Value) {
	e.encodeComplex128(rvGetComplex128(rv))
}

func (e *encoderSimpleIO) kInt(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt(rv)))
}

func (e *encoderSimpleIO) kInt8(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt8(rv)))
}

func (e *encoderSimpleIO) kInt16(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt16(rv)))
}

func (e *encoderSimpleIO) kInt32(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt32(rv)))
}

func (e *encoderSimpleIO) kInt64(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeInt(int64(rvGetInt64(rv)))
}

func (e *encoderSimpleIO) kUint(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint(rv)))
}

func (e *encoderSimpleIO) kUint8(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint8(rv)))
}

func (e *encoderSimpleIO) kUint16(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint16(rv)))
}

func (e *encoderSimpleIO) kUint32(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint32(rv)))
}

func (e *encoderSimpleIO) kUint64(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUint64(rv)))
}

func (e *encoderSimpleIO) kUintptr(f *encFnInfo, rv reflect.Value) {
	e.e.EncodeUint(uint64(rvGetUintptr(rv)))
}

func (e *encoderSimpleIO) kErr(f *encFnInfo, rv reflect.Value) {
	e.errorf("unsupported encoding kind %s, for %#v", rv.Kind(), any(rv))
}
...
func (e *encoderSimpleIO) kStructSfi(f *encFnInfo) []*structFieldInfo {
	if e.h.Canonical {
		return f.ti.sfi.sorted()
	}
	return f.ti.sfi.source()
...
func (e *encoderSimpleIO) HandleName() string {
	return e.hh.Name()
}

func (e *encoderSimpleIO) Release() {
}
...
func (e *encoderSimpleIO) init(h Handle) {
	...
	e.fp = e.e.init(h, &e.encoderShared, e).(*fastpathEsSimpleIO)
...
func (e *encoderSimpleIO) addrRV(rv reflect.Value, typ, ptrType reflect.Type) (rva reflect.Value) {
	if rv.CanAddr() {
		return rvAddr(rv, ptrType)
	}
	if e.h.NoAddressableReadonly {
...
func (e *encoderSimpleIO) wrapErr(v error, err *error) {
	*err = wrapCodecErr(v, e.hh.Name(), 0, true)
}
...
func (e *encoderSimpleIO) haltOnMbsOddLen(length int) {
	if length&1 != 0 {
		e.errorInt("mapBySlice requires even slice length, but got ", int64(length))
	}
}
...
func (d *decoderSimpleIO) selferUnmarshal(f *decFnInfo, rv reflect.Value) {
	rv2i(rv).(Selfer).CodecDecodeSelf(&Decoder{d})
}

func (d *decoderSimpleIO) binaryUnmarshal(f *decFnInfo, rv reflect.Value) {
	bm := rv2i(rv).(encoding.BinaryUnmarshaler)
	xbs := d.d.DecodeBytes(nil)
	fnerr := bm.UnmarshalBinary(xbs)
	d.onerror(fnerr)
...
func (d *decoderSimpleIO) textUnmarshal(f *decFnInfo, rv reflect.Value) {
	tm := rv2i(rv).(encoding.TextUnmarshaler)
	fnerr := tm.UnmarshalText(d.d.DecodeStringAsBytes())
	d.onerror(fnerr)
}

func (d *decoderSimpleIO) jsonUnmarshal(f *decFnInfo, rv reflect.Value) {
	d.jsonUnmarshalV(rv2i(rv).(jsonUnmarshaler))
}
...
func (d *decoderSimpleIO) kErr(f *decFnInfo, rv reflect.Value) {
	d.errorf("unsupported decoding kind: %s, for %#v", rv.Kind(), rv)

}

func (d *decoderSimpleIO) raw(f *decFnInfo, rv reflect.Value) {
	rvSetBytes(rv, d.rawBytes())
}

func (d *decoderSimpleIO) kString(f *decFnInfo, rv reflect.Value) {
	rvSetString(rv, d.stringZC(d.d.DecodeStringAsBytes()))
}

func (d *decoderSimpleIO) kBool(f *decFnInfo, rv reflect.Value) {
	rvSetBool(rv, d.d.DecodeBool())
}

func (d *decoderSimpleIO) kTime(f *decFnInfo, rv reflect.Value) {
	rvSetTime(rv, d.d.DecodeTime())
}

func (d *decoderSimpleIO) kFloat32(f *decFnInfo, rv reflect.Value) {
	rvSetFloat32(rv, d.d.DecodeFloat32())
}

func (d *decoderSimpleIO) kFloat64(f *decFnInfo, rv reflect.Value) {
	rvSetFloat64(rv, d.d.DecodeFloat64())
}

func (d *decoderSimpleIO) kComplex64(f *decFnInfo, rv reflect.Value) {
	rvSetComplex64(rv, complex(d.d.DecodeFloat32(), 0))
}

func (d *decoderSimpleIO) kComplex128(f *decFnInfo, rv reflect.Value) {
	rvSetComplex128(rv, complex(d.d.DecodeFloat64(), 0))
}

func (d *decoderSimpleIO) kInt(f *decFnInfo, rv reflect.Value) {
	rvSetInt(rv, int(chkOvf.IntV(d.d.DecodeInt64(), intBitsize)))
}

func (d *decoderSimpleIO) kInt8(f *decFnInfo, rv reflect.Value) {
	rvSetInt8(rv, int8(chkOvf.IntV(d.d.DecodeInt64(), 8)))
}

func (d *decoderSimpleIO) kInt16(f *decFnInfo, rv reflect.Value) {
	rvSetInt16(rv, int16(chkOvf.IntV(d.d.DecodeInt64(), 16)))
}

func (d *decoderSimpleIO) kInt32(f *decFnInfo, rv reflect.Value) {
	rvSetInt32(rv, int32(chkOvf.IntV(d.d.DecodeInt64(), 32)))
}

func (d *decoderSimpleIO) kInt64(f *decFnInfo, rv reflect.Value) {
	rvSetInt64(rv, d.d.DecodeInt64())
}

func (d *decoderSimpleIO) kUint(f *decFnInfo, rv reflect.Value) {
	rvSetUint(rv, uint(chkOvf.UintV(d.d.DecodeUint64(), uintBitsize)))
}

func (d *decoderSimpleIO) kUintptr(f *decFnInfo, rv reflect.Value) {
	rvSetUintptr(rv, uintptr(chkOvf.UintV(d.d.DecodeUint64(), uintBitsize)))
}

func (d *decoderSimpleIO) kUint8(f *decFnInfo, rv reflect.Value) {
	rvSetUint8(rv, uint8(chkOvf.UintV(d.d.DecodeUint64(), 8)))
}

func (d *decoderSimpleIO) kUint16(f *decFnInfo, rv reflect.Value) {
	rvSetUint16(rv, uint16(chkOvf.UintV(d.d.DecodeUint64(), 16)))
}

func (d *decoderSimpleIO) kUint32(f *decFnInfo, rv reflect.Value) {
	rvSetUint32(rv, uint32(chkOvf.UintV(d.d.DecodeUint64(), 32)))
}

func (d *decoderSimpleIO) kUint64(f *decFnInfo, rv reflect.Value) {
	rvSetUint64(rv, d.d.DecodeUint64())
}
...
func (d *decoderSimpleIO) HandleName() string {
	return d.hh.Name()
}

func (d *decoderSimpleIO) isBytes() bool {
	return d.bytes
}
...
func (d *decoderSimpleIO) init(h Handle) {
	...
	d.fp = d.d.init(h, &d.decoderShared, d).(*fastpathDsSimpleIO)
...
func (d *decoderSimpleIO) arrayCannotExpand(sliceLen, streamLen int) {
	if d.h.ErrorIfNoArrayExpand {
		d.errorf("cannot expand array len during decode from %v to %v", any(sliceLen), any(streamLen))
	}
}

func (d *decoderSimpleIO) haltAsNotDecodeable(rv reflect.Value) {
	if !rv.IsValid() {
		d.onerror(errCannotDecodeIntoNil)
	}
...
func (d *decoderSimpleIO) depthIncr() {
	d.depth++
	if d.depth >= d.maxdepth {
		d.onerror(errMaxDepthExceeded)
	}
...
func (d *decoderSimpleIO) depthDecr() {
	d.depth--
}
...
func (d *decoderSimpleIO) mapStart(v int) int {
	if v != containerLenNil {
		d.depthIncr()
		d.c = containerMapStart
	}
...
func (d *decoderSimpleIO) arrayStart(v int) int {
	if v != containerLenNil {
		d.depthIncr()
		d.c = containerArrayStart
	}
...
func (d *decoderSimpleIO) oneShotAddrRV(rvt reflect.Type, rvk reflect.Kind) reflect.Value {
	if decUseTransient &&
		(numBoolStrSliceBitset.isset(byte(rvk)) ||
			((rvk == reflect.Struct || rvk == reflect.Array) &&
				d.h.getTypeInfo(rt2id(rvt), rvt).flagCanTransient)) {
...
func (d *simpleDecDriverIO) DecodeStringAsBytes() (s []byte) {
	return d.DecodeBytes(nil)
}

func (d *simpleDecDriverIO) DecodeBytes(bs []byte) (bsOut []byte) {
	d.d.decByteState = decByteStateNone
	if d.advanceNil() {
		return
	}
...
func (d *simpleDecDriverIO) nextValueBytesR(v0 []byte) (v []byte) {
	d.readNextBd()
	v = v0
	var h decNextValueBytesHelper
...
func (d *simpleDecDriverIO) nextValueBytesBdReadR(v0 []byte) (v []byte) {
	v = v0
	var h decNextValueBytesHelper
...
func (d *simpleEncDriverIO) init(hh Handle, shared *encoderShared, enc encoderI) (fp interface{}) {
	callMake(&d.w)
	d.h = hh.(*SimpleHandle)
	d.e = shared
	if shared.bytes {
...
func (d *simpleDecDriverIO) init(hh Handle, shared *decoderShared, dec decoderI) (fp interface{}) {
	callMake(&d.r)
	d.h = hh.(*SimpleHandle)
	d.bytes = shared.bytes
	d.d = shared
