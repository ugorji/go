...
func (e *encoderCborBytes) kStructFieldKey_Slow(keyType valueType, encName string) {
...
func (e *encoderCborIO) kStructFieldKey_Slow(keyType valueType, encName string) {
